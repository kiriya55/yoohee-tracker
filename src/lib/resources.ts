...
export function parseResourceIndexText(text: string): ResourceIndex | undefined {
  ...
  for (const [key, value] of Object.entries(parsed.items)) {
    ...
    items[String(id)] = {
      ...
      avatarPending: value.avatarPending === true ? true : undefined,
      avatarPendingReason: typeof value.avatarPendingReason === "string" ? value.avatarPendingReason : undefined,
      avatarPendingPageUrl: typeof value.avatarPendingPageUrl === "string" ? value.avatarPendingPageUrl : undefined,
      avatarPendingSince: typeof value.avatarPendingSince === "string" ? value.avatarPendingSince : undefined,
